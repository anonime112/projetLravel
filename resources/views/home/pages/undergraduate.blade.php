            ...
            <div class="container">
                <div class="banner-spacing">
                    <div class="section-info">
                        <h2 data-aos="fade-up" data-aos-delay="100">Undergraduate</h2>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6">
                                            <div class="problem-items">
                                                <ul>
                                                    ...
                                                    <li><a href="#">Comparative Literature And Culture</a></li>
                                                    <li><a href="#">Computer Science</a></li>
                                                    <li><a href="#">Critical Diversity Studies</a></li>
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-md-6">
                                            <div class="problem-items">
                                                <ul>
                                                    ...
                                                    <li><a href="#">Comparative Literature And Culture</a></li>
                                                    <li><a href="#">Computer Science</a></li>
                                                    <li><a href="#">Chemical Physics</a></li>
                                                    <li><a href="#">Cultural Anthropology</a></li>
                                                    <li><a href="#">Critical Diversity Studies</a></li>
                                                </ul>
                                            </div>
                                        </div>
